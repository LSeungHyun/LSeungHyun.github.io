...
3-1 ~~함정에 충돌시 사망하며 Life가 1 감소된다.~~ (1-3 이승현)

3-2 ~~사망 후 남은 Life가 0이라면 게임의 처음으로 되돌아가게 되며, 남은 Life의 개수가 0을 초과한다면 마지막 SavePoint로 이동하게된다.~~ (1-13 이승현)

3-3 ~~플레이어가 SavePoint존에 들어가게되면 현재 SavePoint의 Position값과 구출한 동료가 저장된다.~~ (3-4 임형균)
